...
<div className="mt-10 ml-2 mr-2">
    <h2 className="hover:transform hover:scale-110 transition duration-500 ease-in-out font-mono text-3xl font-bold mb-10 text-center">Oil Paintings Gallery</h2>
